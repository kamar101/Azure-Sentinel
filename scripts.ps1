$key = "access_key=d99dc4c48498db0c8698bcd2ced300f8"
$API_URl = "http://api.ipapi.com/"
$LOGFILE_PATH = "C:\Users\OneUser\Documents\GeneratedLogs\logs.txt"
...
#you would like to add everthing to functions
#you think it will be nice if request is only made to the api if timestap is unique in the log lfile.
